...
namespace BL {
    public class BLPrestamo {
        ...
        public BLPrestamo(double cantidad, DateTime fechaIni, DateTime fechaFin, DateTime fechaCast, double cuota, double interes, double dineroPagado, Boolean activo, int idPrestamo) {
            Cantidad = cantidad;
